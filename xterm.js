          ...
          let C = 1,
            b = (t.DomRenderer = class extends _.Disposable {
              ...
              _injectCss(e) {
                ...
                (t += `${this._terminalSelector} .${v} .xterm-dim { color: ${
                  l.color.multiplyOpacity(e.foreground, 0.5).css
                };}`),
                ...
                for (const [i, s] of e.ansi.entries())
                  t += `${this._terminalSelector} .${p}${i} { color: ${
                    s.css
                  }; }${this._terminalSelector} .${p}${i}.xterm-dim { color: ${
                    l.color.multiplyOpacity(s, 0.5).css
                  }; }${this._terminalSelector} .${g}${i} { background-color: ${
                    s.css
                  }; }`;
                (t += `${this._terminalSelector} .${p}${
                  a.INVERTED_DEFAULT_COLOR
                } { color: ${l.color.opaque(e.background).css}; }${
                  this._terminalSelector
                } .${p}${a.INVERTED_DEFAULT_COLOR}.xterm-dim { color: ${
                  l.color.multiplyOpacity(l.color.opaque(e.background), 0.5).css
                }; }${this._terminalSelector} .${g}${
                  a.INVERTED_DEFAULT_COLOR
